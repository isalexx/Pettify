<?php require('header.php'); ?>
    ...
    if (!(strlen($type) >= 2 && strlen($type) <= 15))
    {
        array_push($errors, "Please make sure the type is between 2 and 15 characters in length.");
        $ok = false;
    }
    ...
    if (!(strlen($colour) >= 2 && strlen($type) <= 10))
    {
        array_push($errors, "Please make sure the colour is between 2 and 10 characters in length.");
        $ok = false;
    }
